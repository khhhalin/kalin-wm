...
enum Direction { DIR_LEFT, DIR_RIGHT, DIR_UP, DIR_DOWN }; /* directional navigation */
...
typedef struct {
	...
	int nsyms;
	xkb_keysym_t *keysyms; /* invalid if nsyms == 0 */
...
static void resizefocused(const Arg *arg);
