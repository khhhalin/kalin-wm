...
- niri is a scrollable-tiling Wayland compositor and a primary design inspiration for [[kalin-wm]].
- Its scrollable strip of columns inspired the original [[column-layout]] (since replaced by the [[connection-graph]]).
- Its navigation model informed the [[viewport]] approach.
