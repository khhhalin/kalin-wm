...
> ⚠️ **Version Constraint**: Current wlroots 0.20. Some protocols require wlroots 0.21+.

---

## ✅ Essential Protocols (Complete)
...
## ⚠️ Recommended Protocols (3 Missing)
...
**Status:** ❌ UNAVAILABLE (requires wlroots 0.21+)  
...
## 📋 Optional Protocols (Nice to Have)
...
| Game cursor stuck | `zwp_pointer_constraints_v1` | Already implemented ✅ |
| No middle-click paste | `zwp_primary_selection_device_manager_v1` | Already implemented ✅ |
| No screenshot/grim | `zwlr_screencopy_manager_v1` | Already implemented ✅ |
