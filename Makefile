...
SRCS = code/src/dwl.c code/src/util.c code/src/modules/input/commit_size.c code/src/modules/input/resize_actions.c code/src/modules/foreign_toplevel.c code/src/crash_report.c code/src/persistence.c
